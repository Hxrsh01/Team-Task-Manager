...
export default function Signup() {
  ...
  return (
    <div style={{
      ...
      {/* Ambient orbs */}
      <div className="glow-orb" style={{ width: 500, height: 500, background: 'rgba(139,92,246,0.1)', top: '-15%', right: '-10%' }} />
      <div className="glow-orb" style={{ width: 350, height: 350, background: 'rgba(99,102,241,0.08)', bottom: '0%', left: '-5%' }} />
      ...
      <div className="animate-fade" style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14 }}>Create your TRACKER account</p>
        </div>
